...
# Setup
Name "foobox"
OutFile "foobox_x64.en.v${FBOX_VER}-win7-${BUILD_NUM}.exe"
# VerInfo
...
# Runtime
Caption "foobox v${FBOX_VER} [Win7] setup for foobar2000 (x64)"
...
Section "foobox theme and required components" fooboxCore
	...
	File ".\en\x64\profile\user-components-x64\foo_enhanced_spectrum_analyzer\foo_enhanced_spectrum_analyzer.dll"
...
!insertmacro MUI_HEADER_TEXT "Options and Notes" "Important: 64-bit foobar2000 is required."
...
${NSD_CreateCheckbox} 10u 30u 90% 10u "Do not install theme configure files"
Pop $CfgCheckbox
${If} $noConfig = 1
