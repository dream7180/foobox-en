...
class Buttons {
	...
	srcTiptext() {
		...
		const type = panel.m.x > panel.heading.x + panel.heading.w / 2 ? 'Next ' + suffix : panel.m.x > panel.heading.x ? (txt[n].flag && txt[n].flagCountry && panel.m.x < panel.heading.x + but.flag.w ? txt[n].flagCountry : 'Previous ' + suffix) : '';
