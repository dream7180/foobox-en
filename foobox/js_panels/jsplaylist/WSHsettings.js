...
oPage = function(id, objectName, label, nbrows) {
	...
	this.draw = function(gr) {
		...
		case 0:
			...
			gr.GdiDrawText("e.g. D:\\MusicTag\\MusicTag.exe", g_font, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 11.5 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			break;
		case 1:
			var listBoxWidth = zoom(120, zdpi);
