		...
		if (repaint_main || !repaintforced) {
			...
			if (ppt.showHeaderBar) {
				...
				try {
					...
					if(fb.IsPlaying) gr.gdiDrawText(" | "+ playing_title + " [playing] ", g_font, blendColors(g_color_normal_txt, g_color_highlight, 0.4), tx + dlw + source_width, 0, tw - source_width, ppt.headerBarHeight, lc_txt);
