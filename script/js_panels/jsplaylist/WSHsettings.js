		...
		case "up":
			...
			switch (this.link_hover) {
				case 1:
					...
					break;
				case 2:
					utils.Run("https://github.com/dream7180/foobox-en");
					break;
			};
			this.link_hover = 0;
			}
...
oListBox = function(id, object_name, x, y, w, row_num, row_height, label, arr, selectedId, func, parentObject, parentPageId, offset) {
	...
	this.contextMenu = function(x, y, id) {
		...
		case (idx == 10):
			...
			p.headerBar.columns.push(new oColumn("copy of " + c0, c1, c2, "Custom " + num(no_user, 2), c3, c4, 0));
		...
		case (idx == 20):
			...
			p.list.groupby.push(new oGroupBy("copy of "+ c0, c1, c2, "Custom", c3, c4, c5, c6));
			p.list.totalGroupBy++;
			var arr = [];
...
oPage = function(id, objectName, label, nbrows) {
	...
	this.init = function() {
		...
		case 0:
			...
			this.elements.push(new oTextBox(2, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 4.25), oTextBox_4, cHeaderBar.height, "Wheel scroll step (global)", cList.scrollstep.toString(), "settings_textboxes_action", this.id));
			...
			this.elements.push(new oCheckBox(9, 20, cSettings.topBarHeight + rh * 13.5, "Create Queue Content playlist automatically when playback queue is not empty", "queue_pl_on", "settings_checkboxes_action", this.id));
			this.elements.push(new oTextBox(10, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 15), oTextBox_2, cHeaderBar.height, "External applications (Multiple items can be added)", track_edit_app, "settings_textboxes_action", this.id));
			break;
		case 1:
			// Columns
			...
			this.elements.push(new oTextBox(1, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 6.75), oTextBox_3, cHeaderBar.height, "Label", txtbox_value, "settings_textboxes_action", this.id));
			txtbox_value = p.headerBar.columns[listBoxCurrentId].tf;
			this.elements.push(new oTextBox(2, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 8.75), oTextBox_1, cHeaderBar.height, "Title format (enter 'null' for nothing)", txtbox_value, "settings_textboxes_action", this.id));
			txtbox_value = p.headerBar.columns[listBoxCurrentId].tf2;
			this.elements.push(new oTextBox(3, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 10.75), oTextBox_1, cHeaderBar.height, "Extra line title format (enter 'null' for nothing)", txtbox_value, "settings_textboxes_action", this.id));
			txtbox_value = p.headerBar.columns[listBoxCurrentId].sortOrder;
			this.elements.push(new oTextBox(4, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 12.75), oTextBox_1, cHeaderBar.height, "Sort order (enter 'null' for nothing)", txtbox_value, "settings_textboxes_action", this.id));

			// Create radio buttons
			var spaceBetween_w = z(80);
			this.elements.push(new oRadioButton(5, txtbox_x, cSettings.topBarHeight + rh * 15.75, "Left", (p.headerBar.columns[listBoxCurrentId].align == 0), "settings_radioboxes_action", this.id));
			this.elements.push(new oRadioButton(6, txtbox_x + spaceBetween_w, cSettings.topBarHeight + rh * 15.75, "Center", (p.headerBar.columns[listBoxCurrentId].align == 1), "settings_radioboxes_action", this.id));
			this.elements.push(new oRadioButton(7, txtbox_x + spaceBetween_w * 2, cSettings.topBarHeight + rh * 15.75, "Right", (p.headerBar.columns[listBoxCurrentId].align == 2), "settings_radioboxes_action", this.id));
			break;
		case 2:
			// Groups
			...
			this.elements.push(new oTextBox(4, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 13.5), oTextBox_1, cHeaderBar.height, "Header line 1, left field", txtbox_value, "settings_textboxes_action", this.id));
			txtbox_value = p.list.groupby[listBoxCurrentId].r1;
			this.elements.push(new oTextBox(5, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 15.5), oTextBox_1, cHeaderBar.height, "Header line 1, right field", txtbox_value, "settings_textboxes_action", this.id));
			txtbox_value = p.list.groupby[listBoxCurrentId].l2;
			this.elements.push(new oTextBox(6, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 17.5), oTextBox_1, cHeaderBar.height, "Header line 2, left field", txtbox_value, "settings_textboxes_action", this.id));
			txtbox_value = p.list.groupby[listBoxCurrentId].r2;
			this.elements.push(new oTextBox(7, txtbox_x, Math.ceil(cSettings.topBarHeight + rh * 19.5), oTextBox_1, cHeaderBar.height, "Header line 2, right field", txtbox_value, "settings_textboxes_action", this.id));
			break;
		case 3:
			//foobox options
			let checkbox2x = z(260);
			var rh = cSettings.rowHeight;
			...
			this.elements.push(new oRadioButton(1, 20, cSettings.topBarHeight + rh * 4.5, "System", (sys_scrollbar == 1), "settings_radioboxes_action", this.id));
			this.elements.push(new oRadioButton(2, z(120), cSettings.topBarHeight + rh * 4.5, "Narrow", (sys_scrollbar == 0), "settings_radioboxes_action", this.id));
			...
			this.elements.push(new oRadioButton(4, 20, cSettings.topBarHeight + rh * 8.25, "Album List", (libbtn_fuc == 1), "settings_radioboxes_action", this.id));
			this.elements.push(new oRadioButton(5, z(120), cSettings.topBarHeight + rh * 8.25, "ReFacets", (libbtn_fuc == 0), "settings_radioboxes_action", this.id));
			...
			this.elements.push(new oCheckBox(7, checkbox2x, cSettings.topBarHeight + rh * 10.5, "Except background", "cbkg_bycover ? false : true", "settings_checkboxes_action", this.id));
			...
			this.elements.push(new oCheckBox(11, checkbox2x, cSettings.topBarHeight + rh * 6.5, "Colorful seek bar", "colorful_seek ? true : false", "settings_checkboxes_action", this.id));
			...
			this.elements.push(new oCheckBox(17, checkbox2x, cSettings.topBarHeight + rh * 2.5, "Enable D2D rendering (Restart to take effect)", "drawmode == 1 ? true : false", "settings_checkboxes_action", this.id));
			break;
		case 4:
			var arr = [];
			var rh = cSettings.rowHeight;
			...
			spaceBetween_w = z(90);
			this.elements.push(new oRadioButton(11, txtbox_x, cSettings.topBarHeight + rh * 14.5, "Collapse", (layout.config[layout.setting_idx][5] == "1"), "settings_radioboxes_action", this.id));
			this.elements.push(new oRadioButton(12, txtbox_x + spaceBetween_w, cSettings.topBarHeight + rh * 14.5, "Expand", (layout.config[layout.setting_idx][5] == "0"), "settings_radioboxes_action", this.id));
			break;
		};
	};
	...
	this.draw = function(gr) {
		...
		case 0:
			...
			gr.GdiDrawText("(Range: 15-100, Default: 33)", g_font, p.settings.color1, txtbox_x + 82*zdpi, cSettings.topBarHeight + rh * 9.55 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			gr.GdiDrawText("Others", g_font_b, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 10.75 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			gr.GdiDrawText("Such as MusicTag, Mp3tag or spek, can be called in \"Open with\" contextmenu", g_font, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 17 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			...
			gr.GdiDrawText("Add...", g_font_b, p.settings.color2, bx, by, p.settings.btn_off.Width, p.settings.btn_off.Height, cc_txt);
			break;
		case 1:
			var listBoxWidth = z(120);
			gr.GdiDrawText("Text Alignment", g_font_b, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 15 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			// new column button
			...
			if (p.headerBar.columns.length < properties.max_columns) {
				...
				gr.GdiDrawText("New", g_font_b, p.settings.color2, nx, ny, p.settings.btn_off.Width, p.settings.btn_off.Height, cc_txt);
			}
			else {
				...
				gr.GdiDrawText("New", g_font_b, p.settings.color4, nx, ny, p.settings.btn_no.Width, p.settings.btn_no.Height, cc_txt);
			};
			...
			if (ref.substr(0, 6) == "Custom") {
				...
				gr.GdiDrawText("Remove", g_font_b, p.settings.color2, dx, dy, p.settings.btn_off.Width, p.settings.btn_off.Height, cc_txt);
			}
			else {
				...
				gr.GdiDrawText("Remove", g_font_b, p.settings.color4, dx, dy, p.settings.btn_no.Width, p.settings.btn_no.Height, cc_txt);
			};
			break;
		case 2:
			var listBoxWidth = z(175);
			...
			gr.GdiDrawText("Group header fields", g_font_blank, p.settings.color2, txtbox_x, cSettings.topBarHeight + rh * 12.75 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
		...
		case 3:
			...
			gr.GdiDrawText("Bottom control pane", g_font_b, p.settings.color1, txtbox_x, dy + rh * 5.75, txt_width, p.settings.lineHeight, lc_txt);
			...
			gr.GdiDrawText("** Music art **", p.settings.font_title, p.settings.color1, txtbox_x, dy + rh * 17.25, txt_width, p.settings.lineHeight, lc_txt);
		...
		case 4:
			...
			gr.GdiDrawText("Remove invalid layouts", g_font_b, p.settings.color2, dx, dy + rh *1.2, p.settings.btn_off_2.Width, p.settings.btn_off_2.Height, cc_txt);
			gr.GdiDrawText("Group options in the layout:", g_font_b, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 6.75 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			gr.GdiDrawText("Collapsed row height", g_font_b, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 10 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			gr.GdiDrawText("Expanded row height", g_font_b, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 11.75 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			gr.GdiDrawText("Default group status", g_font_b, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 13.75 - (this.offset * cSettings.rowHeight), txt_width, p.settings.lineHeight, lc_txt);
			break;
		};
	...
	this.newButtonCheck = function(event, x, y) {
		...
		case "up":
			if (state == ButtonStates.hover) {
				...
				p.headerBar.columns.push(new oColumn("Custom " + num(no_user, 2), "null", "null", "Custom " + num(no_user, 2), 0, "null", 0));
				p.headerBar.totalColumns++;
				var arr = [];
				fin = p.headerBar.columns.length;
				for (var i = 0; i < fin; i++) {
	...
	this.newButtonPatternCheck = function(event, x, y) {
		...
		case "up":
			if (state == ButtonStates.hover) {
				// action
				p.list.groupby.push(new oGroupBy("Custom pattern", "null", "null", "Custom", "", "", "", ""));
				p.list.totalGroupBy++;
				var arr = [];
				fin = p.list.groupby.length;
				for (var i = 0; i < fin; i++) {
	...
	this.browseButtonCheck = function(event, x, y) {
		...
		case "up":
			if (state == ButtonStates.hover) {
				_app = utils.FilePicker("Add an external application", "", "Excutable file (*.exe)|*.exe|All files (*.*)|*.*", 0);
				if(_app) {
					if(track_edit_app == "") {
...
oSettings = function() {
	...
	this.setButtons = function() {
		...
		rect_w = gb.CalcTextWidth("Remove", g_font_b) + g_z30;
		gb.SetTextRenderingHint(4);
		...
		gb.SetSmoothingMode(0);
		rect_w = gb.CalcTextWidth("Remove invalid layouts", g_font_b) + g_z30;
